...
if(fast_lio2_CONFIG_INCLUDED)
  return()
endif()
set(fast_lio2_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(fast_lio2_SOURCE_PREFIX /home/fangcheng/workspace/fastlio2_ws/src/fast_lio2)
  set(fast_lio2_DEVEL_PREFIX /home/fangcheng/workspace/fastlio2_ws/src/fast_lio2/cmake-build-debug/devel)
  set(fast_lio2_INSTALL_PREFIX "")
  set(fast_lio2_PREFIX ${fast_lio2_DEVEL_PREFIX})
else()
  set(fast_lio2_SOURCE_PREFIX "")
  set(fast_lio2_DEVEL_PREFIX "")
  set(fast_lio2_INSTALL_PREFIX /usr/local)
  set(fast_lio2_PREFIX ${fast_lio2_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'fast_lio2' is deprecated")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    list(APPEND fast_lio2_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/fangcheng/workspace/fastlio2_ws/src/fast_lio2/cmake-build-debug/devel/lib;/home/fangcheng/workspace/ws_livox/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(fast_lio2_LIBRARY_DIRS ${lib_path})
      list(APPEND fast_lio2_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'fast_lio2'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND fast_lio2_LIBRARIES ${lib})
    endif()
  endif()
...
set(fast_lio2_EXPORTED_TARGETS "fast_lio2_generate_messages_cpp;fast_lio2_generate_messages_eus;fast_lio2_generate_messages_lisp;fast_lio2_generate_messages_nodejs;fast_lio2_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${fast_lio2_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 fast_lio2_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${fast_lio2_dep}_FOUND)
      find_package(${fast_lio2_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${fast_lio2_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(fast_lio2_INCLUDE_DIRS ${${fast_lio2_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(fast_lio2_LIBRARIES ${fast_lio2_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${fast_lio2_dep}_LIBRARIES})
  _list_append_deduplicate(fast_lio2_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(fast_lio2_LIBRARIES ${fast_lio2_LIBRARIES})

  _list_append_unique(fast_lio2_LIBRARY_DIRS ${${fast_lio2_dep}_LIBRARY_DIRS})
  list(APPEND fast_lio2_EXPORTED_TARGETS ${${fast_lio2_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "fast_lio2-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${fast_lio2_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
